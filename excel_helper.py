...
class ExcelCredentialsExporter:
    ...
    def _extract_credentials_from_json(
            ...
            for account_name, account_data in data["accounts"].items():
                if "users" in account_data:
                    for user in account_data["users"]:
                        ...
                        credential_row = {
                            "firstname": user.get("real_user", {}).get(
                                "first_name", ""
                            ),
    ...
    def _create_formatted_excel(
        self, credentials_list: List[Dict[str, str]], filename: str
    ) -> str:
    ...
    def create_summary_sheet(
        self, json_file_path: str, excel_filename: str = None
    ) -> str:
...
if __name__ == "__main__":
    ...
    print(
        "Columns will be in order: firstname, lastname, mail id, username, password, loginurl, homeregion, accesskey, secretkey"
    )
