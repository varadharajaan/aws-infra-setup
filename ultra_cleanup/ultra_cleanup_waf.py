...
class UltraCleanupWAFManager:
        ...
        try:
            ...
            try:
                ...
                if acl_list:
                    ...
                    for acl in acl_list:
                        try:
                            self.print_colored(Colors.CYAN,f"{Symbols.DELETE} Deleting Web ACL: {acl['Name']}")
    ...
    def interactive_cleanup(self):
        self.print_colored(Colors.BLUE,"\n"+"="*100+f"\n{Symbols.START} ULTRA AWS WAF CLEANUP\n"+"="*100)
        ...
        self.print_colored(Colors.GREEN,f"\n{Symbols.OK} WAF cleanup completed!")
