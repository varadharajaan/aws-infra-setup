...
def create_test_config():
    ...
    test_config = {
        ...
        "user_settings": {"user_regions": ["us-east-1", "us-west-2"]},
    }
...
def test_basic_functionality():
    ...
    try:
        ...
        custom_rt = {
            ...
            "Associations": [
                {"Main": False, "RouteTableAssociationId": "rtbassoc-456"}
            ],
        }
...
def test_vpc_resource_methods():
    ...
    try:
        ...
        custom_vpcs = manager.get_all_vpcs_in_region(
            mock_ec2_client, "us-east-1", "test-account"
        )
        ...
        endpoints = manager.get_vpc_endpoints(
            mock_ec2_client, ["vpc-custom123"], "us-east-1", "test-account"
        )
        ...
        sgs = manager.get_security_groups(
            mock_ec2_client, ["vpc-custom123"], "us-east-1", "test-account"
        )
