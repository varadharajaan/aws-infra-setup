...
class IAMLogger:
    ...
    def log_user_action(self, username: str, action: str, status: str, details: str = ""):
    ...
    def log_account_action(self, account_name: str, action: str, status: str, details: str = ""):
    ...
    def log_summary(self, total_processed: int, successful: int, failed: int, skipped: int = 0):
    ...
    def log_resource_cleanup(self, username: str, resource_type: str, resource_id: str, status: str):
...
if __name__ == "__main__":
    ...
    logger.log_user_action("test_user01", "CREATE", "SUCCESS", "User created with all permissions")
    logger.log_account_action("account01", "CONNECT", "SUCCESS", "Connected to AWS account")
