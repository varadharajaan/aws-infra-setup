...
def test_single_account():
    ...
    print(f"🔍 Testing account02 in {region}")
    ...
    try:
        ...
        print(f"✅ describe_regions successful")
        ...
        print(f"✅ Found {sg_count} security groups")
        
        print(f"\n✅ All tests passed! Your credentials work fine.")
        return True
