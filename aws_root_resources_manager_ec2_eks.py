...
class AWSAccountResourceManager:
    def __init__(self, 
        ...
        self.current_time = "2025-06-02 04:09:00"
...
"""
        ...
        while True:
            ...
            try:
                ...
                if selected_indices:
                    ...
                    self.print_colored(Colors.GREEN, f"[SUCCESS] Selected {len(selected_indices)} accounts:")
        ...
        try:
            ...
            try:
                ...
                if 'InvalidGroup.Duplicate' in str(e):
                    # Use existing security group with similar name
                    ...
                    if existing_sgs['SecurityGroups']:
                        ...
                        self.log_operation('INFO', f"Using existing security group: {sg_id}")
                    else:
                        raise
                else:
                    raise
    ...
    def run(self):
        ...
        try:
            ...
            for i, idx in enumerate(selected_account_indices, 1):
                ...
                self.print_colored(Colors.YELLOW, f"\n[PROCESSING] Account {i}/{len(selected_account_indices)}: {account_name} ({region})")
                ...
                if i < len(selected_account_indices):
                    time.sleep(5)
            
            # Step 4: Display summary and save results
            self.display_summary(results, resource_type)
    ...
    def display_summary(self, results, resource_type):
        ...
        print("=" * 80)
        print(f"[SUMMARY] Total accounts processed: {total_accounts}")
        ...
        success_rate = ((successful_ec2 + successful_eks) / (total_accounts * 2)) * 100 if total_accounts > 0 else 0
