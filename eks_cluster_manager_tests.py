...
class TestEKSClusterManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.manager = EKSClusterManager(
            config_file=self.config_file, current_user="test-user"
        )
    ...
    def test_deploy_cloudwatch_agent(self, mock_session, mock_run):
        ...
        )  # kubeconfig update + 4 kubectl applies
    ...
    def test_setup_cost_alarms(self, mock_session):
        ...
        result = self.manager.setup_cost_alarms(
            "test-cluster", "us-west-2", mock_cloudwatch_client, "123456789012"
        )
    ...
    @patch.object(
        EKSClusterManager, "ensure_iam_roles", return_value=("role1", "role2")
    )
    @patch.object(
        EKSClusterManager,
        "get_or_create_vpc_resources",
        return_value=(["subnet1", "subnet2"], "sg1"),
    )
    ...
    @patch.object(
        ...
        return_value={"overall_healthy": True, "summary": {"health_score": 95}},
    )
